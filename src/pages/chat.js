...
const Chat = ({ user, userRole, setActiveMenuItem, onUnreadChatsUpdate }) => {
  ...
  }, [selectedChat?.id]) // Removed persistentSuggestions from dependencies to prevent unnecessary resets
  ...
  const handleDeleteConversation = async (conversation) => {
    ...
    try {
      ...
      const chatRef = doc(db, 'chats', conversation.id)
      
      // Soft delete: mark as deleted for this user
      await updateDoc(chatRef, {
        [`deletedFor.${user.uid}`]: serverTimestamp()
      })
      
      console.log('✅ Conversation marked as deleted')
        ...
        <div className={styles.chatListHeader}>
          ...
          <button
            ...
            onClick={() => {
              ...
              if (confirm(`Are you sure you want to delete this conversation with ${selectedChat.otherUserName}? This action cannot be undone.`)) {
                handleDeleteConversation(selectedChat)
              }
            }}

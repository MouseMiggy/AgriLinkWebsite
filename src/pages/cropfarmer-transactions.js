...
const Transactions = ({ user }) => {
  ...
  useEffect(() => {
    ...
    // For crop farmers, get transactions where they are the buyer
    const q = query(
          ...
          <table className={styles.transactionsTable}>
            <thead>
              <tr className={styles.tableHeader}>
                <th className={styles.columnHeader} style={{width: '30%'}}>Listing Name</th>
                <th className={styles.columnHeader} style={{width: '29%'}}>Listing Details</th>
                <th className={styles.columnHeader} style={{width: '16.33%'}}>Seller Name</th>
                <th className={styles.columnHeader} style={{width: '13.33%'}}>Price</th>
                <th className={styles.columnHeader} style={{width: '13.33%'}}>Date Bought</th>
              </tr>
            </thead>
            <tbody>
              {transactions.length === 0 ? (
                  ...
                  <td colSpan="5" className={styles.emptyTableCell}>
                    <div className={styles.emptyTableMessage}>
                      <div className={styles.emptyIcon}>
                        <img src="/assets/icons/scroll-text.png" alt="No transactions" />
                      </div>
                ...
                transactions.map((transaction) => (
                  ...
                  >
                    ...
                    <td className={styles.tableCell} style={{width: '13.33%'}}>
          ...
          <div className={styles.receiptModalContent} onClick={(e) => e.stopPropagation()}>
            ...
            {selectedTransaction && (
              <div className={styles.receiptBody}>
                ...
                <div className={styles.receiptSection}>
                  <h3 className={styles.receiptSectionTitle}>Seller Information</h3>
                  <div className={styles.receiptInfo}>
                    <div className={styles.receiptRow}>
                      <span className={styles.receiptLabel}>Seller Name:</span>
                ...
                <div className={styles.receiptSection}>
                  ...
                  <div className={styles.receiptInfo}>
                    <div className={styles.receiptRow}>
                      <span className={styles.receiptLabel}>Date Bought:</span>
